        ...
        <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" valign="top">
                    ...
                    <form method="post" action="updateLineType.action" enctype="multipart/form-data">
                        <input type="hidden" name="linetype.lineTypeId" value="${lity.lineTypeId}"><br>
                        线路类型名称
                        <input type="text" name="linetype.typeName" value="${lity.typeName}"><br>
                        线路类型图标 <br>
                        <img src="${lity.icon}"style="width: 100px;">
                        <input type="hidden" name="linetype.icon" value="${lity.icon}">
                        <input type="file" value="${lity.icon}" name="file"><br>
