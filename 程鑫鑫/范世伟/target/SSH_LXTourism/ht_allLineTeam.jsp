...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <table border="1px" cellspacing="0px" cellpadding="0px" style="width: 500px;text-align: center">
                        ...
                        <c:forEach items="${lineList}" var="linel">
                                <c:if test="${linel.teamBuy eq 1}" >
                                    <tr>
                                        ...
                                        <td>${linel.days}</td>
                                        <td>${linel.price}</td>
                                        <td>${linel.teamBuyPrice}</td>
                                        <td>${linel.vehicle}</td>
                                        <td><a href="findLineTeam.action?line.lineId=${linel.lineId}&line.lineTypeId=${linel.linetype.lineTypeId}">修改团购信息</a> </td>
                                    </tr>
