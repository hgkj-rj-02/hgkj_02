        ...
        <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" valign="top">
                    ...
                    <form method="post" action="lineTypeInsert.action" enctype="multipart/form-data">
                        线路类型编号
                        <input type="text" name="linetype.lineTypeId"><br>
                        线路类型名称
                        <input type="text" name="linetype.typeName"><br>
                        线路类型图标 <br>
                        <input type="file" value="请选择" name="file" ><br>
