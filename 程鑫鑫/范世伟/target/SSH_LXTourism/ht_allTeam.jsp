                ...
                <td>
                    <table border="1px" cellpadding="0px" cellspacing="0px" style="width: 700px;height: 300px; text-align: center">
                            ...
                            %>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${linel.teamBuy == 1}"><span style="color: #b81900">团购</span></c:when>
                                        <c:otherwise>非团购</c:otherwise>
                                    </c:choose>
                                </td>
                                <td>${linel.linetype.typeName}</td>
                                <td><a href="findLineTeam.action?line.lineId=${linel.lineId}&line.lineTypeId=${linel.linetype.lineTypeId}">设置团购信息</a> </td>
                            </tr>
                            </c:forEach>
                        </table>
                </td>
