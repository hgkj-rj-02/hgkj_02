...
<div id="login-bg">
    <div id="login-m">
        <form action="customerLogin.action" method="post">
            <ul>
                <li>登录名
                    <input name="customer.name" type="text" class="box" id="txtLoginNo" size="33" value="请输入6~12位账号" />
                </li>
                <li>密&nbsp;&nbsp;&nbsp;码
                    <input name="customer.password" type="password" class="box" id="txtPwd" size="33" />
                </li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
