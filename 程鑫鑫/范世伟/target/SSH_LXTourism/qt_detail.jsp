...
<!--主体内容第一部分开始-->
<div class="jindck">
       <div class="jindck-meun">[多重优惠+超值赠送]${line1.lineName}${line1.days}<img src="qt/images/tjcp.jpg" width="40" height="40" /><img src="qt/images/fk.jpg" width="40" height="40" /></div>
       <div class="jin2">
           <div class="jin2-left">
               <ul>

                        <c:forEach items="${line1.pictureSet}" var="line1" begin="0" end="0">
                   <li>
                       <a href="" title="">
                           <img src="${line1.picname}" width="400" height="250" />
                       </a>
                   </li>
                        </c:forEach>

                       <c:forEach items="${line1.pictureSet}" var="line1">
                   <li class="pics">
                           <a href="qt/images/jdckb1.jpg" class="zoom" title="${line1.introductioin}" >
                           <img src="${line1.picname}" width="70" height="43" />
                           </a>
                   </li>
                       </c:forEach>
           ...
           <div class="jin2-right">
               <ul>
                   <li>途乐行价：<span class="colorc">￥${line1.price}</span></li>
                   <li>团购价：<strong>￥${line1.teamBuyPrice}</strong> 起</li>
                   <li>最大优惠：￥100</li>
                   <li>出游天数：${line1.days}</li>
                   <li>出游人数：已有<span>0</span>人出游此线路</li>
                   <li>提前报名：建议提前一天报名</li>
                   <li><a href="insertCar.action?car.customer.customerId=${customerId}&car.line.lineId=${line1.lineId}"><img src="qt/images/jgwc.jpg" width="122" height="42" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="qt_order.jsp"><img src="qt/images/js.jpg" width="123" height="43" /></a></li>
               </ul>
           </div>
       </div>
       <div class="tuijian">
