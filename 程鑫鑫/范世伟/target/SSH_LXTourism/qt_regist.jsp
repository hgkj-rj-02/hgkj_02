    ...
    <div id="reg-mleft">
        <form action="customerInsert.action" method="post" >
            <ul>
                <li class="m">用户帐号 </li>
                <li class="r" >
                    <input name="customer.account" type="text" class="box txtInit" id="txtNo" />
                    <span id='prompt_no' class="spanInit" ></span></li>
                <li class="m">用户姓名 </li>
                <li class="r">
                    <input name="customer.name" type="text" class="box txtInit" id="txtName" />
                    <span id='prompt_name' class="spanInit"  ></span></li>
                <li class="m">设置密码 </li>
                <li class="r">
                    <input name="customer.password" type="password" class="box txtInit" id="txtPwd" />
                    <span id='prompt_pwd'  class="spanInit" ></span></li>
                <li class="m">性 别 </li>
                <li class="r">
                        <input name="customer.gender" type="radio" value="男" checked="checked" id="radio" >男
                        <input name="customer.gender" type="radio" value="女" id="radio2" >女
                    <li class="m">身份证号 </li>
                    <li class="r">
                        <input name="customer.identityId" type="text" class="box txtInit" id="txtId" />
                        <span id='prompt_id' class="spanInit"   ></span></li>

                    <li class="m">手机号码 </li>
                    <li class="r">
                        <input name="customer.tel" type="text" class="box txtInit" id="txtPhone" />
