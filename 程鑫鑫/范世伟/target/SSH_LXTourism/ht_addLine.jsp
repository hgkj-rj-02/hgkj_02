...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="3" valign="top">
                        ...
                        <form action="lineInsert.action" method="post" enctype="multipart/form-data">
                            <table style="width: 600px">
                                ...
                                <tr>
                                    <td>线路价格</td>
                                    <td><input type="text" name="line.price"></td>
                                    <td>出游天数</td>
                                    <td><select name="line.days">
                                    ...
                                    <td>
                                        <select name="line.linetype.lineTypeId">
                                            ...
                                            <c:forEach items="${linetypeList}" var="linetypel">
                                                <option value="${linetypel.lineTypeId}">${linetypel.typeName}</option>
                                            </c:forEach>
                                        </select>
                                    </td>
                                    <td></td>
                            ...
                            <table style="width: 600px">
                                ...
                                <tr>
                                    <td><textarea rows="7" cols="25" name="line.reason"></textarea></td>
                                    <td><textarea rows="7" cols="25" name="line.arrange"></textarea></td>
                                    <td><textarea rows="7" cols="25" name="line.introduction"></textarea></td>
                                </tr>
                            </table>
                            <table style="width: 600px">
                                <tr>
                                ...
                                <TD vAlign=top align=middle>
                                    <TABLE width=98% border=0 align="center" cellPadding=0 cellSpacing=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD width="91%" background="ht/images/admin/images/news-title-bg.gif"
                                                class="left_ts"></TD>
                                            <TD width="5%" background="ht/images/admin/images/news-title-bg.gif"
                                                class="left_txt">&nbsp;
                                            </TD>
                                        </TR>
    ...
    <tr>
        <td valign="bottom" background="ht/images/admin/images/mail_leftbg.gif"><img
                src="ht/images/admin/images/buttom_left2.gif" width="17" height="17"/></td>
        <td background="ht/images/admin/images/buttom_bgs.gif"><img src="ht/images/admin/images/buttom_bgs.gif"
                                                                    width="17" height="17"></td>
        <td valign="bottom" background="ht/images/admin/images/mail_rightbg.gif"><img
                src="ht/images/admin/images/buttom_right2.gif" width="16" height="17"/></td>
    </tr>
</table>
</body>
</html>
