            ...
            <tr>
                <td>
                    <form action="updateLineTeam.action" method="post">
                        ...
                        <input type="hidden" name="line.teamBuy" value="${linel.teamBuy}">
                        <input type="hidden" name="line.onTime" value="${linel.onTime}">
                        <table style="width: 1000px">
                            <tr>
                                <td>线路名称</td>
                                <td><input type="text" name="line.lineName" value="${linel.lineName}"></td>
                                <td>线路价格</td>
                                <td><input type="text" name="line.price" value="${linel.price}"></td>
                                <td><input type="submit" value="设置团购信息"></td>
                            </tr>
                            <tr>
                                <td>出游天数</td>
                                <td><input type="text" name="line.days" value="${linel.days}"></td>
                                <td>团购价格</td>
                                <td><input type="text" name="line.teamBuyPrice" value="${linel.teamBuyPrice}"></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>开团时间</td>
                                <td><input type="text" name="line.beginTime" value="${linel.beginTime}"></td>
                                <td>闭团时间</td>
                                <td><input type="text" name="line.endTime" value="${linel.endTime}"></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>交通工具</td>
                                ...
                                <td><select name="line.linetype.lineTypeId">
                                    <c:forEach items="${linetypeList}" var="linetypel">
                                        <option value="${linetypel.lineTypeId}" <c:if test="${linetypel.lineTypeId eq line.linetype.lineTypeId}">selected="selected"</c:if>>${linetypel.typeName}</option>
                                    </c:forEach>
                                </select>
                                </td>
                                <td></td>
                            ...
                            <tr>
                                <td colspan="2"><textarea rows="7" cols="25" name="line.reason">${linel.reason}</textarea></td>
                                <td colspan="2"><textarea rows="7" cols="25" name="line.arrange">${linel.arrange}</textarea></td>
                                <td><textarea rows="7" cols="25" name="line.introduction">${linel.introduction}</textarea></td>
                            </tr>
                        </table>
                    </form>
                </td>
