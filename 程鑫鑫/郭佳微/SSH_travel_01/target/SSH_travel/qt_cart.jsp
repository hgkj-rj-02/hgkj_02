...
<div id="shop">
    ...
    <div id="shop-xx">
        <ul id="shop1">
            ...
            <c:if test="${line.lineId eq linel.lineId}">
            <%
                a++;
            %>
            <li class="xh"><%=a%></li>
            <li class="lx">
                <div id="luxian">
                    <ul>
                        ...
                        <li><a href="${line2.pictName}" title="${linel.lineName}">
                            <img src="${line2.pictName}" width="87" height="58"  /></a></li>
                        </c:forEach>
                        <li><a href="#">产品编号：${linel.lineId}线路名：${linel.lineName}${linel.lineDays}日游【交通工具+${linel.lineVehicle}】</a></li>
                    </ul>
                </div>
            </li>
            <li class="rs">￥${linel.linePrice}</li>
