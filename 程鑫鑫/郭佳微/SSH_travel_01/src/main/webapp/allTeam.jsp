...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td valign="top" background="ht/images/admin/images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
            <tr>
                <td height="31"><div class="titlebt">查看线路</div></td>
            </tr>
        </table></td>
    ...
    <tr>
        ...
        <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <table border="1px" cellpadding="0px" cellspacing="0px" style="width: 700px;height: 300px; text-align: center">
                            <tr style="background-color: #bbbbbb;">
                                <td style="border: 0px">序号</td>
                                <td style="border: 0px">线路名称</td>
                                <td style="border: 0px">出游天数</td>
                                <td style="border: 0px">线路价格</td>
                                <td style="border: 0px">是否为团购信息</td>
                                <td style="border: 0px">线路类型</td>
                            ...
                            %>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${linel.lineTeamBuy == 1}"><span style="color: #b81900">团购</span></c:when>
                                        <c:otherwise>非团购</c:otherwise>
                                    </c:choose>
                                </td>
                                <td>${linel.linetype.lineTypeName}</td>
                                <td>
                                    <c:if test="${linel.lineTeamBuy != 1}">
                                        <a href="findLineTeam.action?line.lineId=${linel.lineId}&line.lineTypeId=${linel.linetype.lineTypeId}">设置团购信息</a>
                                    </c:if>
                                    <c:if test="${linel.lineTeamBuy == 1}">
                                        <a href="allTeam.action">设置团购信息</a>
                                    </c:if>
                                </td>
                            </tr>
                            </c:forEach>
