...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <form action="allLine.action" method="post">
                        <table border="1px" style="width: 600px;height: 400px;text-align: center" cellpadding="0" cellspacing="0">
                            ...
                            <c:forEach items="${lineList}" var="linel">
                                <tr>
                                    ...
                                    <td><a href="findLine.action?line.lineId=${linel.lineId}&line.lineTypeId=${linel.linetype.lineTypeId}">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="deleteLine.action?line.lineId=${linel.lineId}">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
