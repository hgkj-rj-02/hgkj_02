  ...
  <tr>
    <td width="182" valign="top">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="/ht/addrightLinetype.jsp" target="main">添加线路类型</a></li>
     ...
     <tr>
       <td width="182" valign="top"><div id="container2">
         ...
         <div class="content">
           ...
           <ul class="MM">
             <li><a href="addadminLine.action" target="main">添加线路</a></li>
             <li><a href="allLineAction.action" target="main">查看线路</a></li>
           </ul>
         </div>
       </div>
         <script type="text/javascript">
     ...
     <tr>
       <td width="182" valign="top"><div id="container3">
         ...
         <div class="content">
           ...
           <ul class="MM">
             <li><a href="allTeamLineAction.action" target="main">查看线路</a></li>
             <li><a href="allTeamBuyLineAction.action" target="main">查看团购</a></li>
           </ul>
         </div>
       </div>
         <script type="text/javascript">
