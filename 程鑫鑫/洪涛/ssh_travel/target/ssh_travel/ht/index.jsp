...
<frameset rows="64,*"  frameborder="NO" border="0" framespacing="0">
	<frame src="admintop.jsp" noresize="noresize" frameborder="NO" name="topFrame" scrolling="no" marginwidth="0" marginheight="0" target="main" />
  <frameset cols="200,*"  rows="888,*" id="frame">
