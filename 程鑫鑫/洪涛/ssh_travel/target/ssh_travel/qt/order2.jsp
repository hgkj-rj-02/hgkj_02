...
<div class="dingdan">
    ...
    <div class="dingdan-inf">
        ...
        <form action="" method="post">
            <c:forEach items="${touristList2}" var="touri">
            <div class="vistor_info"> <!--游客的信息,以下是增加，删除的内容-->
                <div class="dingdan-mm">
                    ...
                    <div class="youke">
                        <ul>
                            <li><span>*</span> 真实姓名
                                <input name="tourName" type="text" id="textfield" size="20" value="${touri.tourRealName}" />
                                <a href="#">修改</a></li>
                            <li><span>*</span> 手机
                                <input name="tourPhone" type="text" id="textfield" size="20" value="${touri.tourTel}"/>
                                <a href="#">修改</a></li>
                            <li><span>*</span> 身 份 证
                                <input name="tourCD" type="text" id="textfield" size="20" value="${touri.tourIdCard}" />
                                <a href="#">修改</a></li>
