...
<div id="reg">
  ...
  <form action="addcustomer.action" method="post">
    <ul>
      ...
      <li class="m">确认密码 </li>
      <li class="r">
        <input name="" type="password" class="box txtInit" id="txtConfirmPwd" />
      ...
      <li class="m"> </li>
      <li class="r">
        <input name="customer.custType" type="hidden" value="0" />
        <input type="submit" id="button" value="提交" src="images/but2.jpg"  />
      </li>
      <li class="m"> </li>
      <li class="r">
