...
<div id="content1"> 
  ...
  <div id="con1-left">
    ...
    <div class="cs">
      <ul>
        <c:forEach items="${lineList}" var="line">
          <c:if test="${line.linetype.lineTypeName eq '境内游'}">
            <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
          </c:if>
        </c:forEach>
    ...
    <div class="cs">
      <ul>
        <c:forEach items="${lineList}" var="line">
          <c:if test="${line.linetype.lineTypeName eq '境外游'}">
              <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
          </c:if>
        </c:forEach>
        <%--<li><a href="#">奥地利</a></li>--%>
    ...
    <div class="cs">
      <ul>
        <c:forEach items="${lineList}" var="line">
          <c:if test="${line.linetype.lineTypeName eq '海岛游'}">
              <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
          </c:if>
        </c:forEach>
        <%--<li><a href="#">北海道</a></li>--%>
    ...
    <div class="cs">
      <ul>
        <c:forEach items="${lineList}" var="line">
          <c:if test="${line.linetype.lineTypeName eq '自驾游'}">
              <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
          </c:if>
        </c:forEach>
        <%--<li><a href="#">张家界</a></li>--%>
  ...
  <div id="con-2left">
    <div id="con-2left1">
      ...
      <div class="jingdian">
        <ul>
          <c:forEach items="${lineList}" var="line">
            <c:if test="${line.linetype.lineTypeName eq '一日游'}">
                <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
            </c:if>
          </c:forEach>
          <%--<li><a href="#">古琴台</a></li>--%>
      ...
      <div class="jingdian">
        <ul>
          <c:forEach items="${lineList}" var="line">
            <c:if test="${line.linetype.lineTypeName eq '两日游'}">
                <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
            </c:if>
          </c:forEach>
          <%--<li><a href="#">澳门</a></li>--%>
      ...
      <div class="jingdian">
        <ul>
          <c:forEach items="${lineList}" var="line">
            <c:if test="${line.linetype.lineTypeName eq '多日游'}">
                <li><a href="findindexLineAction.action?line.lineId=${line.lineId}">${line.lineName}</a></li>
            </c:if>
          </c:forEach>
          <%--<li><a href="#">北京</a></li>--%>
