...
<!--主体内容第一部分开始-->
<div class="jindck">
  <c:if test="${line.lineTeamBuy eq 1}">
    <div class="jindck-meun">
      [多重优惠+超值赠送]品质全景，张家界、凤凰、天门山、宝峰湖纯玩双飞5日游<img src="images/tjcp.jpg" width="40" height="40" />
      <img src="images/fk.jpg" width="40" height="40" />
    </div>
  </c:if>
  <c:if test="${line.lineTeamBuy ne 1}">
    <div class="jindck-meun2">
      [多重优惠+超值赠送]品质全景，张家界、凤凰、天门山、宝峰湖纯玩双飞5日游<img src="images/tjcp.jpg" width="40" height="40" />
      <img src="images/fk.jpg" width="40" height="40" />
    </div>
  </c:if>
...
<a href="" title="">
  <c:forEach items="${pictureList}" var="picture">
      <img src="/${picture.pictName}" width="400" height="250">
      <%
          i++;
          if(i==1){
              i=0;
    ...
    <c:forEach items="${pictureList}" var="picture">
        <li class="pics"><a href="/${picture.pictName}" class="zoom" title="${line.lineName}" ><img src="/${picture.pictName}" width="100" height="63" /></a></li>
            <%
          i++;
          if(i==3){
              break;
...
<ul>
<li>途乐行价：<span class="colorc">￥${line.linePrice}</span></li>
    <c:if test="${line.lineTeamBuy eq 1}">
        <li>团购价：<strong>￥${line.lineTeamBuyPrice}</strong> 起</li>
        <li>最大优惠：￥${line.linePrice-line.lineTeamBuyPrice}</li>
    </c:if>
<li>出游天数：${line.lineDays}天</li>
...
<li>
    <a href="insertCartAction.action?car.line.lineId=${line.lineId}&car.customer.customerId=${customer.customerId}"><img src="images/jgwc.jpg"  width="122" height="42" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="order.jsp"><img src="images/js.jpg" width="123" height="43" /></a></li>
    </form>
</ul>
</div>
</div>
