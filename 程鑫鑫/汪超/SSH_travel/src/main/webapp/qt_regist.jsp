...
<div id="reg">
    ...
    <div id="reg-mleft">
        <form action="insertCustomer.action?skip=qt_regist" method="post" onsubmit="return check()">
            <ul>
                <li class="m">用户帐号 </li>
                <li class="r" >
                ...
                <li class="m">设置密码 </li>
                <li class="r">
                    <input name="" type="password" class="box txtInit" id="txtPwd" />
                    <span id='prompt_pwd'  class="spanInit" ></span></li>
                <li class="m">确认密码 </li>
                <li class="r">
                    <input name="customer.custPassWord" type="password" class="box txtInit" id="txtConfirmPwd" />
                ...
                <li class="m">性 别 </li>
                <li class="r">
                    <input name="customer.custSex" type="radio" id="radio" value="男" checked="checked" />
                    男
                    <input type="radio" name="customer.custSex" id="radio2" value="女" />
                    女 </li>
                <li class="m">手机号码 </li>
                <li class="r">
                    <input name="customer.custTel" type="text" class="box txtInit" id="txtPhone" />
                    <span id='prompt_phone' class="spanInit" ></span></li>
                <input type="hidden" name="customer.custType" value="2">
                <%--<li class="m">校验码 </li>--%>
                <%--<li class="r">--%>
