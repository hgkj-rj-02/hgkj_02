...
<!--主体内容第一部分开始-->
<div class="jindck">
    <div class="jindck-meun">[多重优惠+超值赠送]品质全景，张家界、凤凰、天门山、宝峰湖纯玩双飞5日游<img src="qt/images/tjcp.jpg" width="40" height="40" /><img src="qt/images/fk.jpg" width="40" height="40" /></div>
    <div class="jin2">
        <div class="jin2-left">
            <ul>
                <li>
                    <a href="" title="">
                        <img src="qt/images/fhgc.jpg" width="400" height="250" />
                    </a>
                </li>
                <li class="pics"><a href="qt/images/jdckb1.jpg" class="zoom" title="凤凰古城" ><img src="qt/images/jdcks1.jpg" width="100" height="63" /></a></li>
                <li class="pics"><a href="qt/images/jdckb2.jpg" class="zoom" title="凤凰古城"><img src="qt/images/jdcks2.jpg" width="100" height="63" /></a></li>
                <li class="pics"><a href="qt/images/jdckb3.jpg" class="zoom" title="凤凰古城"><img src="qt/images/jdcks3.jpg" width="100" height="63" /></a></li>
        </div>
        <div class="jin2-right">
            <ul>
                ...
                <li>提前报名：建议提前一天报名</li>
                <li><a href="qt_cart.jsp"><img src="qt/images/jgwc.jpg" width="122" height="42" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="order."><img src="qt/images/js.jpg" width="123" height="43" /></a></li>
            </ul>
        </div>
    </div>
    <div class="tuijian">
