...
<head>
    ...
    <script>
        $(function () {
            lineNameByLineTypeId();
        });

        function lineByLineType() {
            $.post(
                "getLineByLineType.action",
                {"line.lineType.lineTypeId": "F1"},
                function (data) {
                    var str1 = "<span>"
                    $(data).each(function () {
                        str1 += "<li><a href='" + this.lineId + "'>" + this.lineName + "</a></li>";
                    });
                    str1 += "</span>"
                    $(".jn").prepend(str1);
                },
        ...
        function lineNameByLineTypeId() {
            $.post(
                "allLineType.action?skip=qtAllLineType",
                function (data) {
                    var str = "<span>";
                    $(data).each(function () {
                        if (this.lineTypeId != "L3") {
                            str += "<div class='" + this.lineTypeId + "'>" + this.lineTypeName + "</div>";
                            str += "<div class='cs'>"
                            str += "<ul>"
                            $.post(
                                "getLineByLineType.action",
                                {"line.lineType.lineTypeId": this.lineTypeId},
                                function (data) {
                                    var str1 = "<span>"
                                    $(data).each(function () {
                                        str1 += "<li><a href='" + this.lineId + "'>" + this.lineName + "</a></li>";
...
<div id="content1">
    ...
    <div id="con1-left">
        ...
        <%--<div class="cs">--%>
            <%--<ul class="jn">--%>
                <%--<li><a href="qt_detail.jsp">凤凰古城</a></li>--%>
                <%--<li><a href="#">云南大理</a></li>--%>
                <%--<li><a href="#">昆明</a></li>--%>
                <%--<li><a href="#">丽江</a></li>--%>
                <%--<li><a href="#">西双版纳</a></li>--%>
        ...
        <%--<div class="cs">--%>
            <%--<ul class="zj">--%>
                ...
                <%--<li><a href="#">木兰天池</a></li>--%>
                <%--<li><a href="#">庐山</a></li>--%>
                <%--&lt;%&ndash;<li><a href="#">农耕年华</a></li>&ndash;%&gt;--%>
            <%--</ul>--%>
        <%--</div>--%>
    </div>
    <!--右侧-->
    <div id="con1-right">
        <div id="right-top">
            ...
            <div class="zcdl">
                <ul>
                    <li style="margin-right:3px;"><a href="qt_login.jsp"><img src="qt/images/dl.jpg" width="85"
                                                                              height="36"/></a></li>
        ...
        <div class="con-2inf">
            <ul>
                ...
                <li class="w440">
                    ...
                    <div class="w440xx"><a href="#">简介：中国文化公园第一连锁品牌，创立于1998年，以“打造世界一流的连锁文化公园”为愿景，旨在为不同的城市，带来同样的欢乐</a>
                        <br/>
                        本线路已有<span>56</span>人出游
                    </div>
                </li>
        ...
        <div class="con-2inf">
            <ul>
                ...
                <li class="w440">
                    ...
                    <div class="w440xx"><a href="#">简介:香港迪士尼乐园(Disneyland,Hong
                        Kong)的面积只有126.82公顷，是全球面积最小的迪士尼乐园，是世界上的第五个迪士尼乐园。</a> <br/>
