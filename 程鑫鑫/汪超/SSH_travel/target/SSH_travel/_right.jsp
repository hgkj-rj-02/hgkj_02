...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td valign="top" bgcolor="#F7F8F9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="2" valign="top"><span class="left_bt">感谢使用途乐行旅游网后台站管理系统程序</span><br>
                    <br>
                    <span class="left_txt">&nbsp;<img src="images/admin/images/ts.gif" width="16" height="16"> 提示：<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您现在使用的是途乐行旅游网后台管理系统，该系统提供对途乐行网站前台数据的实时维护！
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途乐行旅游网，圆您旅行梦想！　 <br>
            ...
            <tr>
                <td width="2%">&nbsp;</td>
                <td width="51%" class="left_txt"><img src="images/admin/images/icon-mail2.gif" width="16" height="11"> <br>客户服务邮箱：www.tlx.com<br>
                    <img src="images/admin/images/icon-phone.gif" width="17" height="14"> 联系方式：888-000-8888</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
        </table></td>
